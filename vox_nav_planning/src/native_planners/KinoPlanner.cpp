...
ompl::control::KinoPlanner::KinoPlanner(const SpaceInformationPtr & si)
: base::Planner(si, "KinoPlanner")
{
  // set planner specs
...
void ompl::control::KinoPlanner::setup()
{
  ...
  nnControl_ = this_nn;
  nnControl_->setDistanceFunction([this](const VertexProperty * a, const VertexProperty * b) { return distanceFunction(a, b); });
