...
{
void SE2Planner::initialize(rclcpp::Node * parent)
{
  ...
  z_elevation_ = parent->declare_parameter("z_elevation", 1.0);
...
std::vector<geometry_msgs::msg::PoseStamped> SE2Planner::createPlan(const geometry_msgs::msg::PoseStamped & start, const geometry_msgs::msg::PoseStamped & goal)
{
  if (!is_map_ready_) {
