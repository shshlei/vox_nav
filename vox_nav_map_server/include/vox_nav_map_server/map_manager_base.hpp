...
#ifndef VOX_NAV_MAP_SERVER__MAP_MANAGER_BASE_HPP_
#define VOX_NAV_MAP_SERVER__MAP_MANAGER_BASE_HPP_
...
{
class MapManagerBase : public rclcpp::Node
{
public:
  ...
  struct CostRegressionParams
  {
    ...
    plane_fit_threshold(10), max_color_range(255.0), cost_critic_weights({0.33, 0.33, 0.33})
    {
    }
  };

  MapManagerBase(const std::string & name);
...
#endif  // VOX_NAV_MAP_SERVER__MAP_MANAGER_BASE_HPP_
