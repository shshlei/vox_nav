  ...
  map_configured_(false)
{
  ...
  get_maps_service_ = this->create_service<vox_nav_msgs::srv::GetOSMRoadTopologyMap>(
  ...
  robot_localization_fromLL_client_node_ = std::make_shared<rclcpp::Node>("osm_map_manager_fromll_client_node");
...
int main(int argc, char const * argv[])
{
  ...
  auto map_manager_node = std::make_shared<vox_nav_map_server::OSMMapManager>();
