...
{
MapManagerBase::MapManagerBase(const std::string & name)
: Node(name), map_configured_(false)
{
  ...
  get_traversability_map_service_ = this->create_service<vox_nav_msgs::srv::GetTraversabilityMap>(
    ...
    std::bind(&MapManagerBase::getGetTraversabilityMapCallback, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));
...
void MapManagerBase::preProcessPCDMap()
{
...
void MapManagerBase::regressCosts()
{
...
void MapManagerBase::handleOriginalOctomap()
{
...
void MapManagerBase::publishMapVisuals()
{
...
void MapManagerBase::getGetTraversabilityMapCallback(const std::shared_ptr<rmw_request_id_t> /*request_header*/,
